...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT_all(
    	...
    	KC_ESC,  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_MINS, KC_EQL,  KC_BSLS, KC_GRAVE,    KC_DEL,  KC_PSLS, KC_PAST, KC_PEQL,
        ...
        KC_LGUI,                                     KC_SPC,                                                                 KC_RALT,              KC_P0,            KC_PDOT
    ),
    [1] = LAYOUT_all(
